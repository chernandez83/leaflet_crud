    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <ul class="navbar-nav" role="nav">
                <li class="nav-item">
                    <a class="nav-link" href="#">Eliminar Vía</a>
                </li>
            </ul>
        </nav>
        <div id="container">
            <div class="row">
                ...
                <div clas="col-md-5">
                    <form class="form-vertical" method="POST" action="borrarvia.php" enctype="multipart/form-data" 
        ...
        <script>
            ...
            let confirmarEliminar = () => {
                return confirm(`Presione OK para eliminar a ${$('#txtvia').val()} de la base de datos`);
            };
