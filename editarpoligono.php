...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark" role="navigation">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#">Editar Polígono</a>
                </li>
            </ul>
        </nav>
        <div id="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    <form class="form-vertical" method="POST" action="insertayactualizapoligono.php" autocomplete="off">
